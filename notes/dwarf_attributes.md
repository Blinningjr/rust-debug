...
## `DW_AT_abstract_origin` <!--- NOTE: Currently used in my debugger -->
This attribute can be found in dies that are in a inlined function and thus the location and the declaration information is split into a pair of dies.
The inlined die contains the location information and point to the declaration die which contains all the other information.
So when I evaluate a inlined variable in my debugger I store the location information form the first die and then use the attribute `DW_AT_abstract_origin` to get to the declaration die and then proceed as normal.

This is partly how it is described in DWARF 4, page 61:
...
## `DW_AT_artificial` <!--- TODO: Don't know how to use this info. -->
...
This is how it is described in DWARF 4, page 34:
